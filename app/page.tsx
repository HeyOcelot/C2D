            ...
            >
              ...
              <div className="bg-[#FFE282] p-8 rounded-[25px] ring-1 ring-gray-200 text-center relative flex flex-col items-center">
                <p className="text-xl text-[#5A5A40] mb-8 font-medium leading-relaxed">
                  Please be advised that you are now leaving to visit our official JustFor.Fans site. The following material depicts a fictional narrative describing adults engaging in consensual fantasy age-play. <b color=#DF08A1>This content may only be viewed and heard by adults over the age of 18.</b>
                </p>
